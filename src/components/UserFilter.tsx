        ...
        >
          <DropdownMenuItem
            ...
            className={cn(
              "cursor-pointer",
              selectedUserId === null &&
                "border border-primary-accent/70 bg-[hsl(var(--surface-4))]",
            )}
          ...
          <DropdownMenuItem
            ...
            className={cn(
              "cursor-pointer",
              isMyMode && "border border-primary-accent/70 bg-[hsl(var(--surface-4))]",
            )}
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-xs text-muted-foreground">
                  {user.stats.unpurchasedItems} {t("товаров")} •{" "}
                  {formatStatsUnpurchasedSummary(user.stats, language)}
                </div>
              </div>
            </DropdownMenuItem>
          ))}

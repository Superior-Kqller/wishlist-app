  ...
  return (
    <SearchField
      ...
      inputClassName={cn(
        ...
        "rounded-lg border-border/55 bg-[hsl(var(--surface-3)/0.72)] pl-10 pr-3 text-sm placeholder:text-muted-foreground-subtle hover:border-primary/32 hover:bg-[hsl(var(--surface-3)/0.88)] focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/32 focus-visible:ring-offset-0",
      )}
    />
  );
}

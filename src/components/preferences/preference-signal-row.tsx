...
export function PreferenceSignalRow({
  ...
  return (
    <div
      ...
      aria-label={t(label)}
      className={cn(
        "grid min-w-0 border-t border-border/38 first:border-t-0",
        compact
    ...
    >
      ...
      {visibleValues.length > 0 ? (
        <div className="flex min-w-0 flex-wrap items-start gap-x-2 gap-y-1 text-xs font-medium leading-relaxed text-foreground/86">

  ...
  return (
    <section
      className={cn(
        ...
        "overflow-hidden border-primary/20 bg-[linear-gradient(120deg,hsl(var(--surface-2)/0.9),hsl(var(--primary)/0.055))]",
      )}
    ...
    >
      ...
      {preferenceCount === 0 ? (
        <div className="border-t border-border/34 px-4 py-4 text-sm text-muted-foreground sm:px-5">
        ...
        <AnimatePresence initial={false}>
          {expanded ? (
            <motion.div
              ...
              className="grid gap-px border-t border-border/34 bg-border/30 lg:grid-cols-3"
            >

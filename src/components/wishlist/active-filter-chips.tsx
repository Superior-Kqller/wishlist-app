  ...
  return (
    ...
    >
      ...
      <button
        type="button"
        onClick={onClearAll}
        className="ml-0.5 rounded-lg px-2 py-1 text-xs font-medium text-muted-foreground underline-offset-4 transition-colors hover:text-foreground hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
      >
        {t("Сбросить всё")}
      </button>
    </div>

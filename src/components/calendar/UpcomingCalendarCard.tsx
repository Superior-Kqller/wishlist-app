...
const stripClass =
  "group inline-flex min-h-11 max-w-full items-center gap-2.5 rounded-full border border-border/55 bg-[hsl(var(--surface-3)/0.55)] py-1.5 pl-3 pr-3.5 text-sm transition-[border-color,background-color] duration-200 hover:border-primary/45 hover:bg-[hsl(var(--surface-3)/0.95)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background";

...
export default function NotFound() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center page-bg px-4 py-8">
      <section className="w-full max-w-lg rounded-2xl border border-border/55 bg-[hsl(var(--surface-2)/0.85)] p-7 text-center shadow-[0_24px_70px_rgba(0,0,0,0.44),inset_0_1px_0_hsl(var(--foreground)/0.05)] sm:p-8">

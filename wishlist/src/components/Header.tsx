...
import { Gift, LogOut, Plus, Link, Settings, Shield, BarChart3, Menu, Palette, Sun, Moon, Monitor, Check } from "lucide-react";
...
export function Header({ onAddItem, onParseUrl }: HeaderProps) {
  ...
  const isAdmin = session?.user ? isAdminClient(session.user as any) : false;
